# IMPORTANT: This file was generated by Cucumber 0.4.0.rc1
...
config.gem 'cucumber',    :lib => false,        :version => '>=0.4.0.rc1' unless File.directory?(File.join(Rails.root, 'vendor/plugins/cucumber'))
